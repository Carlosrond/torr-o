-- Regra da operação: todo pedido fecha em múltiplo de 5 kg no TOTAL (não por SKU).
-- A tela já orienta o vendedor, mas o banco é a única barreira que ninguém contorna —
-- e os totais daqui alimentam todo número do painel.
